...
public interface FlightService {
     ...
     *
     * @param request the search criteria including origin, destination, dates, sorting, and pagination.
     * @return a Mono containing a response DTO with paginated flight offers and the total page count.
     */
